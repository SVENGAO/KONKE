...
def SSHUPGRADE(port):
	...
	# ]
	cmd = [
		'cd /tmp/;wget http://file.nj-ikonke.site:8096/index.php/s/ggKJxmyynerP8EA/download/repairDb_updateCcu.sh;sleep 2;sh repairDb_updateCcu.sh'
	]
	try:
		# 建立一个sshclient对象
